...
public class RieszTransformDialog extends TransformDialog {
  ...
  public void recordParameters() {
    this.settings.record("RieszTransform-order", (JSpinner)this.spnOrder, "2");
  }
  ...
  public GridPanel createPanelParameters() {
    ...
    pn.place(0, 1, (JComponent)this.spnOrder);
    return pn;
  }
  ...
  public void showFilter(int nx, int ny) {
    ...
    for (int i = 0; i < nc; i++)
      stack.setSliceLabel(filter.getName(i), i + 1); 
