...
public class StructureTensorDialog extends JDialog implements ActionListener, WindowListener, Runnable {
  ...
  public StructureTensorDialog(String title, Settings settings, WalkBar walk) {
    ...
    settings.record("StructureTensor-spnSigma", (JSpinner)this.spnSigma, "1");
    settings.record("StructureTensor-spnEpsilon", (JSpinner)this.spnEpsilon, "1");
  ...
  private void doDialog() {
    ...
    pn0.place(1, 2, 1, 1, (JComponent)this.spnSigma);
    pn0.place(1, 3, 1, 1, new JLabel("[pixel]"));
    pn0.place(2, 0, 2, 1, new JLabel("Epsilon"));
    pn0.place(2, 2, 1, 1, (JComponent)this.spnEpsilon);
    ...
    tabbedPane.addTab("Parameters", (Component)pn0);
    tabbedPane.addTab("Color Map", (Component)pn2);
    GridPanel panel = new GridPanel(false, 5);
    panel.place(1, 0, (JComponent)pn1);
    panel.place(2, 0, tabbedPane);
    panel.place(3, 0, 1, 1, 0, (JComponent)pnRun);
    panel.place(4, 0, (JComponent)this.walk);
  ...
  public void run() {
    ...
    if (this.job == this.bnRun) {
      ...
      if (imp != null) {
        ...
        this.tensor.compute(this.gradient.getGradientX(), this.gradient.getGradientY(), this.spnSigma.get(), this.spnEpsilon.get() * 1.0E-5D);
  ...
  private void showColor() {
    ImageWare hue = selectColor(this.cmbHue);
    ImageWare sat = selectColor(this.cmbSat);
    ImageWare bri = selectColor(this.cmbBri);
    DisplayPyramid.colorHSB(hue, sat, bri, 0, false);
  }
